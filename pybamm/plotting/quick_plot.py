...
class QuickPlot:
    ...
    def plot(self, t, dynamic=False):
        ...
        dynamic : bool, optional
            Determine whether to allocate space for a slider at the bottom of the plot when generating a static plot.
            If True, creates a static plot with a slider.
        """
    ...
    def dynamic_plot(self, show_plot=True, step=None):
        """
        Generate a static plot with a slider to control the time.
